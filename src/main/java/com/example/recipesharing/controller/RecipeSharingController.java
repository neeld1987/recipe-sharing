...
public class RecipeSharingController {
    ...
    public ResponseEntity<RecipeCreator> registerUser(@RequestBody @Valid UserDTO userDto){
    ...
    public ResponseEntity<Object> createRecipe(@RequestBody @Valid RecipeDTO recipeDTO,
